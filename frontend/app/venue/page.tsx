...
import { ArrowLeftIcon, MapPinIcon, NavigationArrowIcon, UsersIcon } from '@phosphor-icons/react';

const venueLocations = [
  { id: 1, name: 'Main Hall A', type: 'conference', icon: UsersIcon, floor: 1, color: '#8b5cf6' },
  { id: 2, name: 'Main Hall B', type: 'conference', icon: UsersIcon, floor: 1, color: '#8b5cf6' },
  { id: 3, name: 'Tech Arena', type: 'conference', icon: UsersIcon, floor: 2, color: '#3b82f6' },
  { id: 4, name: 'Innovation Hub', type: 'conference', icon: UsersIcon, floor: 2, color: '#3b82f6' },
  { id: 5, name: 'Workshop Room 1', type: 'workshop', icon: MapPinIcon, floor: 1, color: '#FFA726' },
  { id: 6, name: 'Workshop Room 2', type: 'workshop', icon: MapPinIcon, floor: 1, color: '#FFA726' },
  { id: 7, name: 'Workshop Room 3', type: 'workshop', icon: MapPinIcon, floor: 2, color: '#FFA726' },
];
